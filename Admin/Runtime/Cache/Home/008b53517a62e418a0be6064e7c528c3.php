                  ...
                  <div class="ccenter">
                        <div class="cnav">
                              <ul>
                                   ...
                                   <a href="/EasyTalk/admin.php/Home/Administration/ad-cpsw" class="now-a"><li>密码修改</li></a>
                              </ul>
                        </div>
                        <div class="searchbox">
                        ...
                        <div class="conbox" style="position: relative;">
                              ...
                              <table class="cpsw-table" cellspacing="30" cellpadding="0">
                                    <tr>
                                        <td>旧密码</td>
                                        <td><input type="password" class="cpsw-input" id="cpsw-pass1"></td>
                                    </tr>
                                    <tr>
                                        <td>新密码</td>
                                        <td><input type="password" class="cpsw-input" id="cpsw-pass2"></td>
                                    </tr>
                                    <tr>
                                        <td>确认密码</td>
                                        <td><input type="password" class="cpsw-input" id="cpsw-pass3"></td>
                                    </tr>
                              </table>
                        </div>
                        <div class="call">
                              <div class="call-2">
                                    <input type="button" value="重置" class="call-bu call-bu1" id="cpsw-reset">
                                    <input type="button" value="确认" class="call-bu call-bu1" id="cpsw-up">
                              </div>
                        </div>
                  </div>
            </div>
