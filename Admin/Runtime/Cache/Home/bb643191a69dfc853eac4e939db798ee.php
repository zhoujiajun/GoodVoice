                ...
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!--search start-->
                            <form action="/jobBook/admin.php/Home/Job/job_company_search" method="post" class="col-lg-12">
                                <input type="text" class="form-control" name="keyword" placeholder="输入公司名称..." />
                            </form>
                            <!--search end-->
                                <ul class="result col-lg-12">
                                    <!-- <li><a href="#">残疾人的一生</a></li>
                                    <li><a href="">这都是搜索结果</a></li> -->
                                    <?php if(is_array($companys)): foreach($companys as $key=>$companys): ?><li><a href="/jobBook/admin.php/Home/Job/job_company_edit?com_id=<?php echo ($companys["com_id"]); ?>"><?php echo ($companys["name"]); ?></a></li><?php endforeach; endif; ?>
                                </ul>
                        </div>
                    </section>
                </div>     
