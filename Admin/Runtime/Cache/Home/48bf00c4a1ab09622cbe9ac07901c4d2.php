                  ...
                  <div class="ccenter">
                        <div class="cnav">
                              <ul>
                                   ...
                                   <a href="#" class="labg"><li>练习管理</li></a>
                                   <a href="/EasyTalk/admin.php/Home/Administration/adlangindex?html=16" class="now-a"><li>语种管理</li></a>
                        ...
                        <div class="conbox" style="position: relative;">
                              ...
                              <table class="alang-table">
                                   <tr>
                                        <td><p class="alang-p">请输入想要添加的语种名</p></td>
                                   </tr>
                                   <tr>
                                        <td><input type="text" class="alang-text" id="addlang-text"></td>
                                   </tr>
                              </table>
                        </div>
                        <div class="call">
                              <input type="button" value="确认" class="addtc-button" id="uplangbu">
                              <input type="button" value="返回" class="addtc-button" id="langback">
                        </div>
                  </div>
            </div>
      </div>
