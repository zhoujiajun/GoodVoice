                ...
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!--search start-->
                            <form action="/jobBook/admin.php/Home/Article/article_search" method="post" class="col-lg-12">
                                <input type="text" class="form-control" name="keyword" placeholder="输入干货名称..." />
                            </form>
                            <!--search end-->
                                <ul class="result col-lg-12">
                                    <!-- <li><a href="#">残疾人的一生</a></li>
                                    <li><a href="">这都是搜索结果</a></li> -->
                                    <?php if(is_array($articles)): foreach($articles as $key=>$articles): ?><li><a href="/jobBook/admin.php/Home/Article/article_edit/a_id/<?php echo ($articles['article_id']); ?>"><?php echo ($articles['title']); ?></a></li><?php endforeach; endif; ?>
                                </ul>
                        </div>
                    </section>
                </div>     
