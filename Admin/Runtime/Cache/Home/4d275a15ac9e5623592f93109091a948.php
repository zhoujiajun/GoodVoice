                ...
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!--search start-->
                            <form action="/jobBook/admin.php/Home/Job/job_search" method="post" class="col-lg-12">
                                <input type="text" class="form-control" name="keyword" placeholder="输入岗位名称..." />
                            </form>
                            <!--search end-->
                                <ul class="result col-lg-12">
                                    <?php if(is_array($jobs)): foreach($jobs as $key=>$jobs): ?><li><a href="/jobBook/admin.php/Home/Job/job_edit/job_id/<?php echo ($jobs["job_id"]); ?>"><?php echo ($jobs["name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($jobs["companyname"]); ?></a></li><?php endforeach; endif; ?>
                                </ul>
                        </div>
                    </section>
                </div>     
