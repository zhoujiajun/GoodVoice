...
<!--                              <div class='exe-box' id="123"z>
                                   ...
                                   <input type='button' class='exe-de' value='删除'>
                                   <p hidden="hidden" class='done-p'>1</p>
                             </div>
                             <div class='exe-box'>
                                   <p>法语练习1</p>
                                   <table>
                                   ...
                                   <input type='button' class='exe-de' value='删除'>
                                   <p hidden="hidden" class='done-p'>0</p>
                             </div>
                             <div class='exe-box'>
                                   <p>法语练习1</p>
                                   <table>
                        ...
                        <div class="call">
                              <div class="call-2">
                                    <input type="button" value="添加新练习" class="call-bu call-bu1" id="exe_in_new">
                              </div>
                        </div>
                  </div>
            </div>
