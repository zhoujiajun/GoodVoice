      ...
      <div class="bgbox centerbg-1">
            <div class="centerbg">
                  ...
                  <div class="ccenter">
                        <div class="tnav">
                              <ul>
                                   <a href="/EasyTalk/admin.php/Home/Teacher/tcclass?lan=21" class="now-a"><li>完成课程</li></a>
                        ...
                        <div class="conbox">
                              <table class="contitle" style="margin-left: 30px;">
                                     <tr> 
                                          ...
                                          <td style="width: 90px">语种</td>
                                          <td style="width: 90px">等级</td>
                                          <td style="width: 150px">学员用户名</td>
                                          <td style="width: 210px">学员购买时间</td>
                                          <td style="width: 190px">课程结束时间</td>
                                     </tr>
                              </table>
                              <hr>
                              <div class="condiv">
                                    <table class="contable" style="margin-left: 30px;">
                                           <tr>
                                               ...
                                               <td style='width: 90px'>法语</td>
                                               <td style='width: 90px'>中级</td>
                                               <td style='width: 150px'>欧阳</td>
                                               <td style='width: 210px'>2016-11-19 09:26:40</td>
                                               <td style='width: 190px'>2017-11-19 09:26:40</td>
                                           </tr>
                                    </table>
                              </div>
                        </div>
