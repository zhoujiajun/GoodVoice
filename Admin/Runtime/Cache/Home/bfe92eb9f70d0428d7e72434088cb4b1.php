...
<head>
  ...
  <script type="text/javascript" src="/EasyTalk/BackendPublic/js/text.js"></script>
</head>
<body>
                  ...
                  <div class="ccenter">
                        ...
                        <div class="exe-conbox" style="position: relative;">
                              <table class="exe2_table" cellspacing="26" cellpadding="0">
                                     <tr>
                                         <td>难度</td>
                                         <td><p id="exe_new_level"></p></td>
                                         <td>总分</td>
                                         <td><p id="exe_new_ga"></p></td>
                                         <td>题量</td>
                                         <td><p id="exe_qu"></p></td>
                                         <td>上传时间</td>
                                         <td><p id="exe_new_time"></p></td>
                                     </tr>
                              </table>
<!--                               <div class="exe_single" id="001">
                                   <table class="exe_title_sin">
                                          <tr>
                                              <td>一 单选题</td>
                                              <td>
                                                  <input type="button" name='001' value="删除" class="exe_bu exe_bus_de exe_newb_de">
                                                  <input type="button" name='001' value="编辑" class="exe_bu exe_bus_edi exe_new_edi">
                                                  <input type="button" name='001' value="添加" class="exe_bu exe_bus_edi exe_new_add">
                                              </td>
                                          </tr>
                                   </table>
                                   <div class='exe_sin_box' id="a1" name='001'>
                                        <table>
                                               <tr>
                                                    <td><input type='checkbox' class="checkbox" name="a1"></td>
                                               ...
                                               <tr>
                                                    <td></td>
                                                    <td>
                                                        <label for='a-1-2' class='exe_for_check'><div>B</div></label>
                                               ...
                                               <tr>
                                                    <td></td>
                                                    <td>
                                                        <label for='a-1-3' class='exe_for_check'><div>C</div></label>
                                               ...
                                               <tr>
                                                    <td></td>
                                                    <td>
                                                        <label for='a-1-4' class='exe_for_check'><div>D</div></label>
                                                        <input type='checkbox' id='a-1-4' class='dis-no'>
                                                        <span class='exe_span_top'>Not at all</span>
                                                    </td>
                                                    <td><input type="button" value="编辑" class="exe_bu exe_bus_edi exe_s_edi" name="zgtmid"></td>
                                               </tr>
                                        </table>
                                   </div>
                              </div> -->
                        ...
                        <div class="call">
                              <input type="button" value="暂存" class="call-bu call-bu1 call-bu3" id="exe_tem">
                              <div class="call-2">
                                    <input type="button" value="确认发布" class="call-bu call-bu1" id="exe_is">
                                    <input type="button" value="添加大题" class="call-bu call-bu1" id="exe_new_addbig">
                                    <input type="button" value="删除" class="call-bu call-bu2" id="exe_newa_de">
                              </div>
                        </div>
                  </div>
            </div>
