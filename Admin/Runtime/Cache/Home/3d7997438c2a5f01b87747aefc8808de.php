        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-book"></i> <span>干货板块</span></a>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="/jobBook/admin.php/Home/article/article_upload"> 上传干货</a></li>
                ...
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!-- form start -->
                            <form role="form" method="post" action="/jobBook/admin.php/Home/Article/do_upload" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>正文</label>
                                    <!-- <textarea rows="6" class="form-control" name="content"  id="some-textarea"></textarea> -->
...
<script src="/jobBook/Public/js/prettify.js"></script>
