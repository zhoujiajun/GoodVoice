...
<head>
  ...
  <script type="text/javascript" src="/EasyTalk/BackendPublic/js/jquery.form.js"></script>
            ...
            <div class="centerbg">
                  ...
                  <div class="ccenter">
                        ...
                        <div class="conbox" style="position: relative;">
                              ...
                              <form action="addXiaoti" id="exe_sm_form" method="post" enctype="multipart/form-data">
                                   <table class="exe_ns_table2" cellpadding='0' cellspacing='32'>
                                        <tr>
                                            <td class='exe_a_right'>题目</td>
                                            <td><input type="text" class="exe_input1" name="t_title" id="t_title"></td>
                                        </tr>
                                        <tr>
                                            <td class='exe_a_right'>A</td>
                                            <td><input type='text' class='exe_input2' name="op_a" id="op_a"></td>
                                        </tr>
                                        <tr>
                                            <td class='exe_a_right'>B</td>
                                            <td><input type='text' class='exe_input2' name="op_b" id="op_b"></td>
                                        </tr>
                                        <tr>
                                            <td class='exe_a_right'>C</td>
                                            <td><input type='text' class='exe_input2' name="op_c" id="op_c"></td>
                                        </tr>
                                        <tr>
                                            <td class='exe_a_right'>D</td>
                                            <td><input type='text' class='exe_input2' name="op_d" id="op_d"></td>
                                        </tr>
                                        <tr>
                                            <td class='exe_a_right'>答案</td>
                                            <td><select class="exe_ns_selcet" name="answer" id="answer">
                                                    <option value=""></option>
                                   ...
                                   <div class='exe_gabox'>
                                         ...
                                         <input type="text" value="2" style="display: none;" id="ga_input" name="point">
                                         <span>分</span>
                        ...
                        <div class="call">
                              <div class="call-2">
                                    <input type="button" value="确认" class="call-bu call-bu1" id="exe_sm_up">
