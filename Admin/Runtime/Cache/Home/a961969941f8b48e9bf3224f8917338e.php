                  ...
                  <div class="ccenter">
                        ...
                        <div class="conbox" style="position: relative;">
                              ...
                              <table class="exe_big_table" cellspacing="30" cellpadding="0">
                                    <!-- <tr>
                                         <td>题号</td>
                                         <td><input type="text" class="exe_big_input" id="exe_edib_title"></td>
                                    </tr> -->
                                    <tr>
                                         <td>描述</td>
                                         <td><!-- <input type="text" class="exe_big_input" id="exe_edib_des"> -->
                                             <textarea id="exe_edib_des" class="exe_big_input"></textarea>
                                         </td>
                                    </tr>
                              </table>
                        </div>
                        <div class="call">
                              <div class="call-2">
                                    <input type="button" value="确定" class="call-bu call-bu1" id="exe_edib_up">
                                    <input type="button" value="取消" class="call-bu call-bu2" id="exe_edib_back">
                              </div>
                        </div>
                        </form>
                  </div>
