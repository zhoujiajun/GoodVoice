        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-book"></i> <span>意见反馈</span></a>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="/JobBook/admin.php/Home/feedback/hasdeal">已处理</a></li>
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$list): ?><a href="/JobBook/admin.php/Home/Feedback/feedback_detail/id/<?php echo ($list["id"]); ?>" class="a-panel">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <p>
                                <?php if(empty($list['reply']) == true): ?><span class="quene">（待处理）</span><?php endif; ?>
                                <?php if(empty($list['reply']) != true): ?><span class="solved">（已处理）</span><?php endif; ?>
