...
<head>
  ...
  <script type="text/javascript" src="/EasyTalk/BackendPublic/js/adclass-add.js"></script>
</head>
<body>
                        ...
                        <div class="conbox" style="position: relative;">
                              ...
                              <table class="add-table" cellpadding="0" cellspacing="30">
                                    <tr>
                                         ...
                                         <td><select name="lang" id="lang" class="add-input1">
                                         ...
                                         <td><select name="rank" id="rank" class="add-input1">
                                                  <option value="请选择">请选择</option>  
                                         ...
                                         <td><select name="classnum" id="classnum" class="add-input1">
                                                  <option value="请选择">请选择</option>  
                                    ...
                                    <tr>
                                         ...
                                         <td><select name="tcname" id="tcname" class="add-input1">
                                                  <option value="请选择">请选择</option>
                                              </select>
                                         </td>
                                         <td><p style="margin-left: 30px;">课名</p></td>
                                         <td><input type="text" value=" 输入该课程名称" class="add-input1" id="classname"></td>
                                         ...
                                         <td>
                                          <div class="add-imgbox">
                                             ...
                                             <input type="text" value="0" class="add-input2">
                              ...
                              <textarea name="classde" id="classde" class="add-input3"></textarea>
                        </div>
                        <div class="call">
                              <div class="call-2">
                                    <input type="button" value="确认添加" class="call-bu call-bu1" id="up-classform">
                              </div>
                        </div>
                  </div>
            </div>
