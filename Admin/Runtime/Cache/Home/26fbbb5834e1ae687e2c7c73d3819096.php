                ...
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <!-- form start -->
                            <form role="form" method="post" action="/jobBook/admin.php/Home/Job/job_upload_detail">
                                ...
                                <center><input type="submit" class="btn btn-mystyle" style="width:150px;" value="下一步"></center>
                            </form>
                            <!-- form end -->
                        </div>
                    </section>
