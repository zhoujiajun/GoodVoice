...
<head>
  ...
  <script type="text/javascript" src="/EasyTalk/Public/js/inbuyclass.js"></script>
...
<body>
      ...
      <div class="bgbox navbg-1">
      	   <div class="navbg">
               <ul>
                  ...
                  <a href="/EasyTalk/index.php/Home/Course/buyclass_vie" class="nava nowa"><li id="nav4">课程购买</li></a>
      ...
      <div class="bgbox centerbg-1">
            <div class="centerbg-noheight">
                  <div class="buynav">
                        <ul>
                            <a href="/EasyTalk/index.php/Home/Course/buyclass_vie" class="buynav1 lan01"><li>越南语</li></a>
                            <a href="/EasyTalk/index.php/Home/Course/buyclass_thai" class="buynav1 lan02"><li>泰语</li></a>
                            <a href="/EasyTalk/index.php/Home/Course/buyclass_indon" class="buynav1 lan03"><li>印尼语</li></a>
                            <a href="/EasyTalk/index.php/Home/Course/buyclass_arabic" class="buynav1 lan04"><li>阿拉伯语</li></a>
                        </ul>
                  </div>
                  <div class='bcrightbg'>
                      <div class="addbox">
<!--                         <div class='allbox'>
                              <div class='inbox1'>
                                    ...
                                    <table class='inbox1-table1' cellpadding="0" cellspacing="18">
                                          ...
                                          <tr>
                                              ...
                                              <td><p class='ranktd'>中级</p></td>
                                          </tr>
                                    </table>
                                    <table class='inbox1-table2' cellpadding='0' cellspacing='18'>
                                           <tr>
                                              <td>课程量</td>
                                              <td style='text-align: right;'>12节</td>
                                          </tr>
                                          <tr>
                                              <td>价格￥</td>
                                          ...
                                          <tr>
                                              <td colspan='2'>
                                                  <button class='buybutton' name=''>购买</button>
                                              </td>
                                          </tr>
                                    </table>
                              </div>
                              <div class="inbox2 boxspan">
                                    <p>课程简介</p>
                                    <div>
                                         学会用法语掌如何进行自我介绍，介绍家人，请别人作自我介绍，描述自己的个人兴趣，描述活动，表述频率或强度，描述人物的外貌及衣着，描述人物的社会、文化及地理背景信息，表达愿望，礼貌提出要求，介绍计划，表述自己的梦想和所关注的问题。
                                    </div>
                              </div>
                              <div class="inbox3">
                                    <img src="/EasyTalk/Public/src/images/teacherQF.png">
                                    ...
                                    <div>
                                         <p>简介</p>
                                         <div>北京外国语大学法语教学法专业，大学期间曾公派至比利时翻译学院主修同声传译。语言功底扎实，讲一口流利动听的法语。课堂风格沉稳严谨又不失幽默，喜欢大量使用音频视频资料来帮助学生提高听力口语水平。</div>
                                    </div>
                              </div>
                        </div>
                        <hr> -->
