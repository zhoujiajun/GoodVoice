...
class PayController extends Controller
{
    ...
    public function doalipay(){
        ...
        //建立请求
        $alipaySubmit = new \Vendor\Alipay\Submit($alipay_config);
...
/*服务器异步通知页面方法*/
    function notifyurl(){
        $alipay_config=C('alipay_config');
        //计算得出通知验证结果
        $alipayNotify = new \Vendor\Alipay\Notify($alipay_config);
    ...
    function returnurl(){
        ...
        $alipay_config=C('alipay_config');
        $alipayNotify = new \Vendor\Alipay\Notify($alipay_config);//计算得出通知验证结果
